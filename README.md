...
`sample.cpp` runs the algorithm, outputs sampled DAG scores and a matrix of edge probabilities (parent = row, child = column), and contains instructions for adjusting parameters.
